...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'HelloService2'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from HelloService2.HelloService2Impl import HelloService2
impl_HelloService2 = HelloService2(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['HelloService2.say_hello_async'] = ['HelloService2', 'say_hello']
async_check_methods['HelloService2.say_hello_check'] = ['HelloService2', 'say_hello']
sync_methods['HelloService2.say_hello'] = True
